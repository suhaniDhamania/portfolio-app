  ...
  return (
    <div className="container-fluid home-container " id="home">
      <div className="container home-content">
        ...
        <p className="col-12 ">
          Welcome to my portfolio! I’m Suhani, an Intern Developer at Subharti
          University..Exited to share my Creative Journey with you. let's Dive
          into some awesome projects together!
        </p>
